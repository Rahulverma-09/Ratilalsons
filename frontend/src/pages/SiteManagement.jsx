...
const SITE_API_BASE = "http://127.0.0.1:8000/api/sites";
const GENERATOR_API_BASE = "http://127.0.0.1:8000/api/generators-utilities/generators";
const VEHICLE_API_BASE = "http://127.0.0.1:8000/api/generators-utilities/vehicles";
const EMPLOYEE_API_BASE = "http://127.0.0.1:8000/api/auth/users?skip=0&limit=100";
const REPORTS_API_BASE = "http://127.0.0.1:8000/api/generators-utilities/reports";
const PAGE_SIZE = 10;
const CHART_COLORS = {
  primary: "#3B82F6",
  secondary: "#10B981",
