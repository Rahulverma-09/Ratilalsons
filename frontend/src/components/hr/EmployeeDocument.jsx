...
const HRDocumentReview = () => {
  ...
  const fetchDocuments = async () => {
    ...
    try {
      ...
      const url = filterStatus === 'all'
        ...
        : `http://127.0.0.1:8000/api/documents?status=${filterStatus}`;
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/api/documents/review/${selectedDocument.id}`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`
        },
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        <a
                          href={`http://127.0.0.1:8000${doc.pdf_url}`}
                          target="_blank"
          ...
          >
            ...
            >
              <div className="p-6 sm:p-8">
                ...
                <div className="mb-6">
                  <a
                    href={`http://127.0.0.1:8000${selectedDocument.pdf_url}`}
                    target="_blank"
                    rel="noopener noreferrer"
